...
with tab_khai_hq:
    ...
    loai_tk = c_out1.selectbox("Loại Tờ Khai*", options=list(loai_options.keys()), format_func=lambda x: loai_options[x], key="create_loai_tk")
...
with tab_container:
    ...
    df_cd_cont = db.execute_query("SELECT id, ngay_chuyen_di, dia_diem_giao_nhan FROM chuyen_di ORDER BY id DESC LIMIT 100")
